...
export const metadata: Metadata = {
    ...
    description:
        'Real-time Q&A platform for events, webinars, and conferences. Submit questions anonymously, vote on the best ones, and engage with your audience professionally.',
    keywords: [
        'Q&A platform',
        'live questions',
        'event engagement',
